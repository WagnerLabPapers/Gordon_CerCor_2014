function [subj] = AG1create_xvalid_indices_trainActivesOnly(subj,runs_selname,varargin)

% from CREATE_XVALID_INDICES in the princeton mvpa toolbox
%
% modified by amg
%
% creates xvalid_indices but exclude non-active training trials
%
