function [subj] = AG1create_top_N_vox_thresh_mask(subj,map_patin,new_maskname,nVox_thresh,varargin)

% originally 'CREATE_nVox_thresh_MASK' in the princeton MVPA toolbox
